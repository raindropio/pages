...
export function validateURL(url) {
    ...
    const username = hostname.endsWith('.' + links.pub.domain) ? hostname.slice(0, -(links.pub.domain.length + 1)) : ''
    return hostname !== links.pub.domain && hostname.endsWith(links.pub.domain) &&
        usernameRegex.test(username) && (pathname === '/' || pathname === '')
}
